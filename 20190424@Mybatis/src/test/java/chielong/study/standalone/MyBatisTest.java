...
import chielong.study.standalone.mapper.BlogMapperExt;
...
public class MyBatisTest {
    ...
    public void testStatement() throws IOException {
        ...
        try {
            Blog blog = (Blog) session.selectOne("chielong.study.standalone.mapper.BlogMapper.selectBlogById", 1);
    ...
    public void testMapperExt() throws IOException {
        ...
        try {
            ...
            Blog blog = mapper.selectBlogByName("haha");
            System.out.println(blog);
            // 继承了父Mapper的方法
