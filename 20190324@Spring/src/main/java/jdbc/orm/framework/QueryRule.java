...
public class QueryRule implements Serializable {
    private static final long serialVersionUID = -6004220585444534677L;
    ...
    public QueryRule addDescOrder(String propertyName) {
        this.ruleList.add(new Rule(DESC_ORDER , propertyName).setAndOr(AND));
        return this;
    }
    ...
    protected class Rule implements Serializable {
        private static final long serialVersionUID = 2565032315580927689L;
        ...
        public Rule(int paramInt, String property_name) {
            this.type = type;
            this.propertyName = property_name;
        }

        public Rule(int paramInt, String property_name, Object[] paramArrayOfObject) {
            this.type = type;
            this.propertyName = property_name;
            this.values = values;
        }
